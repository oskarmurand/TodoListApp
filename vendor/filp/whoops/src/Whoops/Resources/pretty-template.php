            ...
            <?php foreach($v->frames as $i => $frame): ?>
              ...
              <?php $line = $frame->getLine(); ?>
                <div class="frame-code <?php echo ($i == 0 ) ? 'active' : '' ?>" id="frame-code-<?php echo $i ?>">
                  ...
                  <?php
                    // Append tasks for this frame */
                    $tasks = $frame->gettasks();
                  ?>
                  <div class="frame-tasks <?php echo empty($tasks) ? 'empty' : '' ?>">
                    <?php foreach($tasks as $taskNo => $task): ?>
                      <?php
                        extract($task)
                         ...
                         */
                      ?>
                      <div class="frame-task" id="task-<?php echo $i . '-' . $taskNo ?>">
                        <span class="frame-task-context"><?php echo $e($context) ?></span>
                        <?php echo $e($task, true) ?>
                      </div>
                    <?php endforeach ?>
                  </div>
