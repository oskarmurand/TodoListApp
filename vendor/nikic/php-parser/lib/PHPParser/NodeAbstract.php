...
abstract class PHPParser_NodeAbstract implements PHPParser_Node, IteratorAggregate
{
    ...
    /**
     * Gets the doc task of the node.
     *
     * The doc task has to be the last task associated with the node.
     *
     * @return null|PHPParser_task_Doc Doc task object or null
     */
    public function getDoctask() {
        ...
        if (!$lasttask instanceof PHPParser_task_Doc) {
            return null;
        }
