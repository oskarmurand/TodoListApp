...
class PHPParser_Tests_LexerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function provideTestError() {
        return array(
            array('<?php /*', 'Unterminated task on line 1'),
            ...
            array(
                ...
                array(
                    ...
                    array(
                        ...
                        array(
                            'startLine' => 3,
                            'tasks' => array(new PHPParser_task_Doc('/** doc' . "\n" . 'task */', 2))
                        ),
                        array('endLine' => 3)
                    ),
                )
                ...
                array(
                    array(
                        ...
                        array(
                            'startLine' => 2,
                            'tasks' => array(
                                new PHPParser_task('/* task */', 1),
                                new PHPParser_task('// task' . "\n", 1),
                                new PHPParser_task_Doc('/** doctask 1 */', 2),
                                new PHPParser_task_Doc('/** doctask 2 */', 2),
                            ),
                        ),
                        array('endLine' => 2)
                    ),
